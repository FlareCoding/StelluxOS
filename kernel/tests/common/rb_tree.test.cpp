...
struct rb_tree_test_item {
    uint64_t key;
    rbt::node link;
};

struct rb_tree_test_cmp {
    bool operator()(const rb_tree_test_item& a, const rb_tree_test_item& b) const {
        return a.key < b.key;
    }
};

using test_tree = rbt::tree<rb_tree_test_item, &rb_tree_test_item::link, rb_tree_test_cmp>;
...
TEST(rb_tree, insert_duplicate_rejected) {
    rb_tree_test_item a{10, {}};
    rb_tree_test_item b{10, {}};
    test_tree tree;
...
TEST(rb_tree, find_missing_key) {
    rb_tree_test_item a{10, {}};
    rb_tree_test_item b{20, {}};
    rb_tree_test_item c{30, {}};
    test_tree tree;
    ...
    rb_tree_test_item probe{25, {}};
    EXPECT_NULL(tree.find(probe));

    rb_tree_test_item probe2{0, {}};
    EXPECT_NULL(tree.find(probe2));

    rb_tree_test_item probe3{99, {}};
    EXPECT_NULL(tree.find(probe3));
}

TEST(rb_tree, insert_ascending) {
    constexpr size_t N = 64;
    rb_tree_test_item items[N];
...
TEST(rb_tree, min_max) {
    rb_tree_test_item a{5, {}};
    rb_tree_test_item b{3, {}};
    rb_tree_test_item c{8, {}};
    rb_tree_test_item d{1, {}};
    rb_tree_test_item e{9, {}};
    test_tree tree;
