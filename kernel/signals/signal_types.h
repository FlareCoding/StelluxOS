...
// sigaction flags (Linux ABI subset the kernel interprets)
...
// SIGKILL and SIGSTOP can never be blocked, caught, or ignored
...
// Per-task signal state. pending is set by senders (atomic OR),
