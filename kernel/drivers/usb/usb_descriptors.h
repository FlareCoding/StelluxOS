#ifndef STELLUX_DRIVERS_USB_USB_DESCRIPTORS_H
#define STELLUX_DRIVERS_USB_USB_DESCRIPTORS_H
...
constexpr uint8_t USB_DESCRIPTOR_STRING                          = 0x03;
constexpr uint8_t USB_DESCRIPTOR_INTERFACE                       = 0x04;
constexpr uint8_t USB_DESCRIPTOR_ENDPOINT                        = 0x05;
constexpr uint8_t USB_DESCRIPTOR_DEVICE_QUALIFIER                = 0x06;
constexpr uint8_t USB_DESCRIPTOR_OTHER_SPEED_CONFIGURATION       = 0x07;
constexpr uint8_t USB_DESCRIPTOR_INTERFACE_POWER                 = 0x08;
constexpr uint8_t USB_DESCRIPTOR_OTG                             = 0x09;
constexpr uint8_t USB_DESCRIPTOR_DEBUG                           = 0x0A;
constexpr uint8_t USB_DESCRIPTOR_INTERFACE_ASSOCIATION           = 0x0B;
constexpr uint8_t USB_DESCRIPTOR_BOS                             = 0x0F;
constexpr uint8_t USB_DESCRIPTOR_DEVICE_CAPABILITY               = 0x10;
constexpr uint8_t USB_DESCRIPTOR_WIRELESS_ENDPOINT_COMPANION     = 0x11;
constexpr uint8_t USB_DESCRIPTOR_SUPERSPEED_ENDPOINT_COMPANION   = 0x30;
constexpr uint8_t USB_DESCRIPTOR_SUPERSPEEDPLUS_ISO_ENDPOINT_COMPANION = 0x31;
...
constexpr uint8_t USB_DESCRIPTOR_HID_PHYSICAL_REPORT             = 0x23;
...
constexpr uint8_t USB_DESCRIPTOR_BILLBOARD                       = 0x0D;
...
#endif // STELLUX_DRIVERS_USB_USB_DESCRIPTORS_H