...
#define SCHED_STACK_TOP_PADDING     0x100

#define SCHED_KERNEL_STACK_PAGES    2
#define SCHED_USER_STACK_PAGES      2

#define SCHED_KERNEL_STACK_SIZE     SCHED_KERNEL_STACK_PAGES * PAGE_SIZE - SCHED_STACK_TOP_PADDING
#define SCHED_USER_STACK_SIZE       SCHED_USER_STACK_PAGES * PAGE_SIZE - SCHED_STACK_TOP_PADDING
