...
/**
 * @brief Cancel a blocked sleep for the given task and wake it.
 * No-op if task is not currently sleeping in a timer queue.
 * Safe from IRQ context and remote CPUs.
 * @note Privilege: **required**
 */
