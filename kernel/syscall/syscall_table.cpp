...
__PRIVILEGED_CODE void init_syscall_table() {
    ...
    REGISTER_SYSCALL(linux_nr::SETPGID,         setpgid);
    ...
    REGISTER_SYSCALL(linux_nr::UMASK,           umask);
    REGISTER_SYSCALL(linux_nr::PRCTL,           prctl);
    ...
    REGISTER_SYSCALL(linux_nr::SENDMSG,     sendmsg);
    REGISTER_SYSCALL(linux_nr::RECVFROM,    recvfrom);
    REGISTER_SYSCALL(linux_nr::RECVMSG,     recvmsg);
    ...
    REGISTER_SYSCALL(linux_nr::CHMOD,       chmod);
