...
QEMU_FLAGS := $(COMMON_QEMU_FLAGS) -drive if=pflash,format=raw,unit=0,file="efi/OVMF_CODE.fd",readonly=on
...
install-dependencies:
	sudo apt-get install build-essential g++ gnu-efi mtools dosfstools qemu-system -y
